...
export default async function Home(){
 ...
 return <>
  ...
  <main className="wrap hero">
   ...
   <section className="card" id="invitatie"><div className="eyebrow">invitație personală</div><h2>☕ Bem o cafea?</h2><p>Dacă și tu cauți o relație serioasă, spune-mi câteva lucruri despre tine. Dacă există interes reciproc, continuăm în spațiul nostru privat.</p><InvitationForm/></section>
  </main>
