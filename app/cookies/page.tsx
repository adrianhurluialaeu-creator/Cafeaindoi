...
export default function Page(){return <><header><div className="wrap"><nav><Link className="brand logo-link" href="/" aria-label="Cafea în Doi — pagina principală"><Image className="site-logo" src="/images/ChatGPT Image 20 sept. 2026, 20_47_04.png" width={1536} height={512} alt="Cafea în Doi — Mai mult decât o cafea"/></Link><div className="links"><Link href="/">Acasă</Link><Link href="/povestea-mea">Povestea mea</Link><Link href="/intre-noi-doi">Între Noi Doi</Link><Link href="/blog">Blog</Link><Link href="/#invitatie">Bem o cafea?</Link><Link href="/contact">Contact</Link></div></nav></div></header><main className="story"><h1>Cookies</h1>
...
<p>Cafea în Doi nu intenționează să folosească cookie-uri de publicitate sau tracking comportamental. Infrastructura tehnică poate utiliza sau genera date strict necesare pentru furnizarea, securitatea și protecția site-ului împotriva abuzului.</p>
...
<p>Dacă în viitor vor fi introduse analytics neesențiale, publicitate, tracking sau alte tehnologii care necesită consimțământ, acestea nu vor fi activate înainte de alegerea utilizatorului. Site-ul va afișa informații despre scop, furnizor și opțiunile de acceptare sau refuz.</p>
