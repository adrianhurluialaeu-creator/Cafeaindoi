...
export async function POST(req:NextRequest){
 ...
 try{const input=await req.json();if(input?.test===true){const result=await sendPush("Cafea în Doi","Notificările pe telefon funcționează.");return NextResponse.json(result)}
