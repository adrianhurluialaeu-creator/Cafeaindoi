 ...
 return <>
  ...
  {data?<>
   ...
   <section className="stats-kpis">
    ...
    <article><span>Apeluri video</span><strong>{data.summary.videoCalls}</strong><small>{data.summary.conversations} conversații create</small></article>
   </section>
