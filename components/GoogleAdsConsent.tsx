...
export default function GoogleAdsConsent(){
 ...
 return <>
  ...
  <Script src="https://www.googletagmanager.com/gtag/js?id=AW-18467510680" strategy="afterInteractive"/>
  <Script id="google-ads-tag" strategy="afterInteractive">{`gtag('js',new Date());gtag('config','AW-18467510680');`}</Script>
  {choice===null&&<div className="consent-banner" role="dialog" aria-label="Preferințe cookies"><p><strong>Cookies pentru măsurare</strong><br/>Folosim Google Ads numai cu acordul tău.</p><div><button className="btn" onClick={()=>choose("granted")}>Accept</button><button className="btn secondary" onClick={()=>choose("denied")}>Refuz</button><a href="/cookies">Detalii</a></div></div>}
 </>;
}
