...
export default function CompatibilityTest(){
 ...
 const go=(n:number)=>{setStep(n);requestAnimationFrame(()=>document.querySelector(".compat")?.scrollIntoView({behavior:"smooth",block:"start"}))};
