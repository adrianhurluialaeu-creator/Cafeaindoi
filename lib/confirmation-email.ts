...
export async function sendConfirmationEmail(invitation:Invitation){
 ...
 const text=`Bună, ${invitation.prenume}!\n\nConfirm cafeaua noastră pentru ${time} (ora României).\n\nConversația continuă în spațiul privat Cafea în Doi.\n\nAdrian · Cafea în Doi`;
 const html=`<div style="font-family:Arial,sans-serif;max-width:600px;margin:auto;color:#33241f"><h2>☕ Cafea în Doi</h2><p>Bună, ${escapeHtml(invitation.prenume)}!</p><p>Confirm cafeaua noastră pentru <strong>${escapeHtml(time)} (ora României)</strong>.</p><p>Conversația continuă în spațiul privat Cafea în Doi.</p><p>Adrian · Cafea în Doi</p></div>`;
